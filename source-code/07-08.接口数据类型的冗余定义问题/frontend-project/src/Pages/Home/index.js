...
var Home = /** @class */ (function (_super) {
    ...
    function Home() {
        ...
        _this.handleLogoutClick = function () {
            request_1.default.get('/api/logout').then(function (res) {
                var data = res.data;
                if (data) {
                    _this.setState({
                        isLogin: false
        ...
        _this.handleCrowllerClick = function () {
            request_1.default.get('/api/getData').then(function (res) {
                var data = res.data;
                if (data) {
    ...
    Home.prototype.componentDidMount = function () {
        var _this = this;
        request_1.default.get('/api/isLogin').then(function (res) {
            var data = res.data;
            if (!data) {
                _this.setState({
                    isLogin: false,
        ...
        request_1.default.get('/api/showData').then(function (res) {
            var data = res.data;
            if (data) {
